      ...
      <main className="flex flex-col md:justify-center md:-translate-y-12 items-center h-screen p-2">
        ...
        >
          ...
          <p className="mt-2">
            ...
            deposit via PayPal or bank transfer. If you don't send the deposit
            in the next 24 hours after my response, you will loose your spot (if
            you transferred the deposit via bank transfer please let me know and
            send me a transfer confirmation via email). Please let me know if
            you decide to cancel the appointment and not pay the deposit. If you
            booked a Custom Design the artist will draw a new design based on
            your reference image, you can discuss with the artist if you would
            like to add any changes during your appointment.
          </p>
          ...
          <p className="mt-2">
            ...
            session there will be discounts. Please don't book if you are not
            ready to pay the deposit. I ONLY work with my own handwriting
            (cursive or capital letters) and Blackletter/Gothic , I do not do
            other typographies. I don’t tattoo ribs (under boob is ok depending
            the design). FLASH PREFERRED.
          </p>
          ...
          <p className="mt-2">
            ...
            reach that area (fx: if you want it above the knee, bring shorts.
            Please bring cash, it is also possible to pay per PayPal.
          </p>
        </Window>
      </main>
    </>
